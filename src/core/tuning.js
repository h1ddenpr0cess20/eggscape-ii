 ...
 * tests both read from here, which is what keeps a generated ditch a ditch the
 * egg can actually clear: reach is derived from these, never guessed.
 */
...
/**
 * Lane index → world x. Lane 1 is the middle furrow of a three-furrow plot,
 * and lane 0 is the one on the left of the screen.
 *
 ...
 * that tests a point against a plot wants them the other way round.
 */
...
/** How long a full hop hangs, and how high it gets — the field's ruler. */
...
/** A hay bale, which is chest-high on an egg and wider than it is deep. */
export const BALE = { halfWidth: 0.55, halfDepth: 0.45, height: 0.95 };
export const CROP = { reach: 0.95, lift: 0.75 };

/** Below this the egg is gone down the bank; plots never sit lower than zero. */
export const FALL_Y = -5;

/** How far a landing may snap up — under a raised plot's lip, nothing does. */
export const SNAP = 0.55;

export const LIVES = 3;
export const INVULNERABLE = 1.6;
/** A metre, a crop out of the ground, and a bale burst with a slam. */
export const SCORE = { perMetre: 1, perCrop: 25, perBale: 60 };

/** How much field is kept live around the egg. */
